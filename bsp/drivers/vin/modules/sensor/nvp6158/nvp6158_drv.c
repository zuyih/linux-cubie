...
int nvp6158_init_ch_hardware(struct tvin_init_info *tvin_info)
{
	...
	if (chip_nvp6158_id[0] == NVP6158C_R0_ID || chip_nvp6158_id[0] == NVP6158_R0_ID) {
		...
		case CVBS_PAL:
			nvp6158_set_chnmode(ch, AHD20_SD_SH720_PAL);
			sensor_print("nvp6158_set_chnmode(ch, AHD20_SD_SH720_PAL);\n");
			break;
		case CVBS_NTSC:
			nvp6158_set_chnmode(ch, AHD20_SD_SH720_NT);
			sensor_print("nvp6158_set_chnmode(ch, AHD20_SD_SH720_NT);\n");
			break;
		case CVBS_H1440_PAL:
		...
		case AHD720P30:
			...
			sensor_print("nvp6158_set_chnmode(ch, AHD20_720P_30P);\n");
			break;
		case AHD1080P25:
		...
		case AHD1080P30:
			...
			sensor_print("nvp6158_set_chnmode(ch, AHD20_1080P_30P);\n");
			break;
		default:
			nvp6158_set_chnmode(ch, AHD20_720P_25P);
			sensor_print("nvp6158_set_chnmode(ch, AHD20_720P_25P);\n");
